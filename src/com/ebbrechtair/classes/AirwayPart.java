...
public class AirwayPart extends GeoCoordinate{
    ...
    public AirwayPart(String atsID, int atsPartition, String fixID, Double lon, Double lat, String iDOfNextFix, Double lonNext, Double latNext, int inBoundCourse, int outBoundCourse, Double legLength) {
        super(lat,lon);
        this.atsID = atsID;
